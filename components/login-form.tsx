...
export function LoginForm({ className, defaultFlow = "signIn", ...props }: LoginFormProps) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader>
        <Link href="/" className="text-2xl font-extrabold tracking-tight text-foreground mx-auto mb-4">
          Quiz<span className="text-muted-foreground">lr</span>
        </Link>
          <CardTitle>{flow === "signIn" ? "Welcome back" : "Create an account"}</CardTitle>
          <CardDescription>
            {flow === "signIn"
              ? "Sign in to your Quizlr account"
